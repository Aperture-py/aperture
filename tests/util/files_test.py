...
class FilesTest(util_test_helper.UtilTest):
    ...
    @unittest.skip('need to implement get_file_paths_from_inputs test')
    def test_get_file_paths_from_inputs(self):
        """Test for the get_file_paths_from_inputs function.
        """
        return None

    @unittest.skip('need to implement get_files_recursively test')
